...
wait
mv ~/DBIS/asterix-tests/test2nc2dp/max/query_metrics.csv ~/DBIS/results/test2nc2dp/max/query_metrics_max_2gb.csv
...
wait
mv ~/DBIS/asterix-tests/test2nc2dp/max/query_metrics.csv ~/DBIS/results/test2nc2dp/max/query_metrics_max_4gb.csv
python3 ~/DBIS/asterix-tests/test2nc2dp/max/optquery_max_4gb.py
wait
mv ~/DBIS/asterix-tests/test2nc2dp/max/query_metrics.csv ~/DBIS/results/test2nc2dp/max/opt_query_metrics_max_4gb.csv
# 8gb
python3 ~/DBIS/asterix-tests/test2nc2dp/max/query_max_8gb.py
wait
mv ~/DBIS/asterix-tests/test2nc2dp/max/query_metrics.csv ~/DBIS/results/test2nc2dp/max/query_metrics_max_8gb.csv
...
wait
mv ~/DBIS/asterix-tests/test2nc2dp/max/query_metrics.csv ~/DBIS/results/test2nc2dp/max/query_metrics_max_16gb.csv
...
wait
mv ~/DBIS/asterix-tests/test2nc2dp/max/query_metrics.csv ~/DBIS/results/test2nc2dp/max/query_metrics_max_32gb.csv
...
wait
mv ~/DBIS/asterix-tests/test2nc2dp/max/query_metrics.csv ~/DBIS/results/test2nc2dp/max/query_metrics_max_64gb.csv
