...
wait
mv ~/DBIS/asterix-tests/test2nc2dp/min/query_metrics.csv ~/DBIS/results/test2nc2dp/min/query_matrices_min_2gb.csv
...
wait
mv ~/DBIS/asterix-tests/test2nc2dp/min/query_metrics.csv ~/DBIS/results/test2nc2dp/min/query_matrices_min_4gb.csv
python3 ~/DBIS/asterix-tests/test2nc2dp/min/optquery_min_4gb.py
wait
mv ~/DBIS/asterix-tests/test2nc2dp/min/uery_metrics.csv ~/DBIS/results/test2nc2dp/min/opt_query_metrics_min_4gb.csv
# 8gb
python3 ~/DBIS/asterix-tests/test2nc2dp/min/query_min_8gb.py
wait
mv ~/DBIS/asterix-tests/test2nc2dp/min/query_metrics.csv ~/DBIS/results/test2nc2dp/min/query_matrices_min_8gb.csv
...
wait
mv ~/DBIS/asterix-tests/test2nc2dp/min/query_metrics.csv ~/DBIS/results/test2nc2dp/min/query_matrices_min_16gb.csv
...
wait
mv ~/DBIS/asterix-tests/test2nc2dp/min/query_metrics.csv ~/DBIS/results/test2nc2dp/min/query_matrices_min_32gb.csv
...
wait
mv ~/DBIS/asterix-tests/test2nc2dp/min/query_metrics.csv ~/DBIS/results/test2nc2dp/min/query_matrices_min_64gb.csv
