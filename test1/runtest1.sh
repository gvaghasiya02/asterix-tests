...
wait
mv query_metrics.csv ~/DBIS/results/test1/opt_query_metrics_count_2gb.csv
# 4gb
...
wait
mv uery_metrics.csv ~/DBIS/results/test1/opt_query_metrics_count_4gb.csv
# 8gb
...
wait
mv query_metrics.csv ~/DBIS/results/test1/opt_query_metrics_count_8gb.csv
# 16gb
...
wait
mv query_metrics.csv ~/DBIS/results/test1/opt_query_metrics_count_16gb.csv
# 32gb
...
wait
mv query_metrics.csv ~/DBIS/results/test1/opt_query_metrics_count_32gb.csv
# 64gb
...
wait
mv query_metrics.csv ~/DBIS/results/test1/opt_query_metrics_count_64gb.csv